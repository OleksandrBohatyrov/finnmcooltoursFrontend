...
function TourDetails() {
  ...
  // Current user’s ID (from Auth/Me)
  const [currentUserId, setCurrentUserId] = useState('');

  const originalPaxMap = useRef({});

  // States for Add Passenger form
  ...
  const markCheckedIn = async id => {
    try {
      ...
      setRecords(prev =>
        prev.map(r =>
          r.id === id ? { ...r, checkedIn: true, checkedInBy: currentUserId } : r
        )
      );
    } catch (err) {
      console.error(err);
  ...
  // Remove check-in: opens confirmation dialog
  ...
  // Remove passenger with confirmation
  ...
  return (
    <div style={styles.container}>
      ...
      {/* Button to toggle Add Passenger form */}
                      ...
                      {r.checkedIn ? (
                        ...
                        <>
                          ...
                          <button
                            ...
                            onClick={() => handleRemovePassenger(r)}
                          >
                            Delete
                          </button>
                        </>
